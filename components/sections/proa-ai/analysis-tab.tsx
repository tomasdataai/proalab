        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-800 p-4 rounded-lg">
              <p className="text-sm text-white">Crecimiento Sectorial</p>
              <p className="text-2xl font-bold text-[#E50695]">+27%</p>
              <p className="text-xs text-gray-200">Tecnología e Innovación</p>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg">
              <p className="text-sm text-white">Demanda Laboral</p>
              <p className="text-2xl font-bold text-[#E50695]">Alta</p>
              <p className="text-xs text-gray-200">Próximos 5 años</p>
            </div>
          </div>

          <div className="bg-gray-800 p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              <p className="text-lg font-semibold text-white">Competencias más valoradas</p>
              <FileText className="h-4 w-4 text-[#E50695]" />
            </div>
            <ul className="space-y-2 text-sm">
              <li className="flex items-center justify-between">
                <span className="text-gray-200">Pensamiento analítico</span>
                <span className="text-[#E50695]">95%</span>
              </li>
              <li className="flex items-center justify-between">
                <span className="text-gray-200">Programación avanzada</span>
                <span className="text-[#E50695]">92%</span>
              </li>
              <li className="flex items-center justify-between">
                <span className="text-gray-200">Gestión de proyectos</span>
